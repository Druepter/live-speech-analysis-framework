...
public class ModeSelection {
	...
	public void createModeSelectionFrame() {
		...
		JButton lispDetection = new JButton("Lisp Detection");
		...
		JButton noiseGate = new JButton("Noise Gate");
				...
				Thread modeSelectionThread = new Thread(new Runnable() {
					...
					public void run() {
						...
						try {
							...
							// TODO Auto-generated catch block
							ErrorGUI errorGUI = new ErrorGUI("Config file not found. Create one to use the application!");
							e.printStackTrace();
						}
